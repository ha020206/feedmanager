...
4. **Secrets 추가** (총 7개)
   ...
   **Secret 1: Gemini API Key**
   - Name: `GEMINI_API_KEY`
   - Secret: `AIzaSyAVfxac7gUFsri0JF76FoKGQXaGHAFgfoM`
   - `Add secret` 클릭

   **Secret 2: Firebase API Key**
   - Name: `FIREBASE_API_KEY`
   - Secret: `AIzaSyDBDRT042h98U3TFzuWgPedwmgwfrwB41U`
   - `Add secret` 클릭

   **Secret 3: Firebase Auth Domain**
   - Name: `FIREBASE_AUTH_DOMAIN`
   - Secret: `instapro-33c7b.firebaseapp.com`
   - `Add secret` 클릭

   **Secret 4: Firebase Project ID**
   - Name: `FIREBASE_PROJECT_ID`
   - Secret: `instapro-33c7b`
   - `Add secret` 클릭

   **Secret 5: Firebase Storage Bucket**
   - Name: `FIREBASE_STORAGE_BUCKET`
   - Secret: `instapro-33c7b.firebasestorage.app`
   - `Add secret` 클릭
   ...
   **Secret 7: Firebase App ID**
   ...
   - Secret: `1:759406377032:web:099959715a914678b4c07d`
   - `Add secret` 클릭
