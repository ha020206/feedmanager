...
현재 `src/firebase.js`에 설정된 정보:
```javascript
apiKey: "AIzaSyDBDRT042h98U3TFzuWgPedwmgwfrwB41U"
authDomain: "instapro-33c7b.firebaseapp.com"
projectId: "instapro-33c7b"
```

이 정보가 Firebase Console의 프로젝트 설정과 일치하는지 확인하세요.
